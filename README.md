...
16、预览页面可以添加删除阀门。
17、对于不检修的环状消火栓管网，计算结果的意义不到，我们需要考虑的是检修情况。阀门设置完毕后，你可以在某段管道上右键选此管检修，程序会自动关闭涉及到阀门，提出不能过水的管道，然后再计算，就可以知道某段管道检修时的水压和流量分布了。计算完后，在检修管道群任一管道右键选不再检修，恢复管道状态。再去选别的管道检修和计算。
